        ...
        <KTCodePreview v-bind:title="'Profile Card'">
          <template v-slot:preview>
            ...
            <v-card class="mx-auto" max-width="434" tile>
              <v-img height="100%" src="assets/media/blog/blog5.jpg">
                <v-row align="end" class="fill-height">
                  <v-col align-self="start" class="pa-0" cols="12">
                    <v-avatar class="profile" color="grey" size="164" tile>
                      <v-img src="assets/media/users/300_21.jpg"></v-img>
                    </v-avatar>
                  </v-col>
                  <v-col class="py-0">
        ...
        <KTCodePreview v-bind:title="'Default slot'">
          <template v-slot:preview>
            ...
            <v-row justify="space-around">
              ...
              <v-avatar>
                <img src="assets/media/users/100_4.jpg" alt="Sean" />
              </v-avatar>
...
>
  <v-img
    height="100%"
    src="assets/media/blog/blog5.jpg"
  >
    <v-row
      align="end"
      class="fill-height"
